...
const Breakdown = () => {
  ...
  const currentData = testData.slice(indexOfFirstItem, indexOfLastItem);
    ...
    <div className="container bg-white p-8 mx-auto my-4 rounded-lg w-15/16">
      ...
      <div className="flex flex-wrap justify-between items-center gap-4">
        <span className="text-sm text-gray-500">
          ...
          {Math.min(indexOfLastItem, testData.length)} of {testData.length} entries
        </span>
        ...
        <div className="flex items-center space-x-3">
          <div className="flex items-center space-x-3">
            ...
            {[...Array(Math.ceil(testData.length / itemsPerPage))].map((_, index) => (
              <button
                key={index}
