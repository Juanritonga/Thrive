        ...
        <table className="min-w-full bg-white border rounded-lg">
          <thead>
            <tr className="text-custom-blue bg-gray-200">
              ...
              <th className="py-3 px-4 border">Total Area</th>
          ...
          <tbody>
            {currentData.map((item) => (
              ...
              >
                ...
                <td className="py-3 px-4">{item.totalArea}</td>
