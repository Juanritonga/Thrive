...
export const testData = [
    {
      ...
      {
        lotno: "LN002",
        transferTo: "Company B",
        transferDate: "2025-04-03",
        reason: "Sale",
        remark: "Repeat buyer",
      },
      {
        lotno: "LN003",
        transferTo: "Company C",
        transferDate: "2025-04-05",
        reason: "Return",
        remark: "Product issue",
      },
      {
        lotno: "LN004",
        transferTo: "Company D",
        transferDate: "2025-04-07",
        reason: "Sale",
        remark: "New customer",
      },
      {
        lotno: "LN005",
        transferTo: "Company E",
        transferDate: "2025-04-10",
        reason: "Sale",
        remark: "Discounted price",
      },
      {
        lotno: "LN006",
        transferTo: "Company F",
      ...
      {
        lotno: "LN010",
        transferTo: "Company J",
        transferDate: "2025-04-21",
        reason: "Sale",
        ...
        <table className="min-w-full bg-white border rounded-lg">
          <thead>
            <tr className="text-custom-blue bg-gray-200">
              ...
              <th className="py-3 px-4 border">Transfer To</th>
              <th className="py-3 px-4 border">Transfer Date</th>
          ...
          <tbody>
            {currentData.map((item, index) => (
              ...
              >
                ...
                <td className="py-3 px-4">{item.transferTo}</td>
                <td className="py-3 px-4">{item.transferDate}</td>
